          ...
          {orders.map((order) => (
            <li key={order.id}>
              <Link
                ...
                className="block border border-border bg-white p-6 transition-colors hover:border-(--color-accent)"
              >
                <div className="flex flex-wrap items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-2 font-english text-xl text-(--color-text)">
                  ...
                  <div className="text-end">
                    ...
                    <p className="mt-3 font-english text-lg text-(--color-text)">
