...
export default async function DashboardPage() {
  ...
  const stats = [
    { label: "Clients", value: clients.total, href: "/admin/clients" },
    { label: "Pieces", value: pieces.total, href: "/admin/pieces" },
    { label: "Orders", value: orders.total, href: "/admin/orders" },
    {
