...
const variantClasses = {
  primary: "border border-[var(--color-gold)] bg-transparent text-[var(--color-gold)] hover:bg-[var(--color-gold)] hover:text-[var(--color-void)] focus-visible:shadow-[var(--shadow-focus)]",
  ghost: "border border-[var(--color-border)] bg-transparent text-[var(--color-ivory)] hover:border-[var(--color-gold)] hover:text-[var(--color-gold-light)] focus-visible:shadow-[var(--shadow-focus)]",
  danger: "border border-[var(--color-ruby)] bg-transparent text-[var(--color-ruby)] hover:bg-[var(--color-ruby)] hover:text-[var(--color-ivory)] focus-visible:shadow-[var(--shadow-focus)]",
} as const;
