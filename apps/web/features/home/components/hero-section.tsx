    ...
    <section className="relative overflow-hidden">
      <div className="relative h-[calc(100dvh-78px)] md:h-[calc(100dvh-115px)] bg-ds-surface">
        ...
        <div className="absolute inset-x-0 bottom-20 mx-auto flex flex-col items-center px-4 text-center sm:bottom-30">
          <h2 className="font-heading rtl:font-arabic text-2xl font-semibold text-white sm:text-3xl max-w-225">
            {t.rich("heroTitle", {
          ...
          <button
            ...
            className="hero-cta-gradient mt-6 inline-flex items-center gap-2 px-6 py-2.5 rounded-[var(--radius-button)] font-body rtl:font-arabic text-sm font-medium tracking-wide text-ds-secondary transition-all duration-300 hover:scale-105 hover:shadow-lg cursor-pointer sm:mt-8"
          >
            {t("exploreAllPieces")}
            <ChevronsDown
              size={16}
