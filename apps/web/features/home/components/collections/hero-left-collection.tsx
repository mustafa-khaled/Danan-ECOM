...
export function HeroLeftCollection({
  ...
  return (
    <div className="relative aspect-video sm:aspect-16/7 lg:aspect-16/6 min-h-105 sm:min-h-125 lg:min-h-150 xl:min-h-170 bg-(--color-surface) overflow-hidden group">
      ...
      />
      {/* Text content */}
      <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-10 md:p-14 lg:p-20 xl:p-28">
        ...
        {collection.description && (
          <p className="mt-3 max-w-xl lg:max-w-3xl xl:max-w-4xl text-white/95 font-medium text-base sm:text-xl md:text-2xl lg:text-3xl leading-relaxed">
            {collection.description}
          </p>
        )}
        <Link
