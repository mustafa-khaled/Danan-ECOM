    ...
    <section className="relative w-full min-h-[calc(100dvh-78px)] md:min-h-[calc(100dvh-115px)] overflow-hidden bg-black flex flex-col justify-end">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 md:px-14 lg:px-16 pt-12 pb-[18vh] sm:pb-[20vh] md:pb-[24vh] flex flex-col items-start justify-end flex-1">
        <div className="max-w-4xl">
          <h1 className="font-english text-white font-bold text-lg sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl leading-[1.15] drop-shadow-sm whitespace-nowrap">
            Every Great Story Has an Origin
          </h1>
          <p className="mt-4 md:mt-6 text-white/90 text-sm sm:text-base md:text-lg leading-relaxed font-normal">
